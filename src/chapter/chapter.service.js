...
exports.getChaptersWithProgress = async (userId) => {
  ...
  const progressList = await ChapterProgress.findAll({
    ...
    attributes: ["chapter_id", "is_theory_completed", "is_quiz_completed", "is_chapter_completed"],
    raw: true,
  });
  ...
  const result = chapters.map((chapter) => {
    ...
    return {
      ...
      is_theory_completed: !!progress.is_theory_completed,
      is_quiz_completed: !!progress.is_quiz_completed,
      is_chapter_completed: !!progress.is_chapter_completed,
    };
  });
